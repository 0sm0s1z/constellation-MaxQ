...
- Hero launch graphic is Cue-exported `public/art/maxq-launch.webm`, played once and held (GIF fallback if video fails, still for reduced motion). Wordmark is `public/namelogo.svg` as a CSS mask. See `docs/BRAND.md`.
